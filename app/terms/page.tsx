  ...
  return (
    <section className={css.terms}>
      <div className={css.termsContainer}>
        ...
        <p>
          These terms and conditions apply to the Star Force app (hereby referred to as
          "Application") for mobile devices that was created by (hereby referred to as "Service
        ...
        <p>
          ...
          security of your phone and access to the Application. The Service Provider strongly advise
          against jailbreaking or rooting your phone, which involves removing software restrictions
          and limitations imposed by the official operating system of your device. Such actions
          could expose your phone to malware, viruses, malicious programs, compromise your phone's
        ...
        <ul>
          <li>
            <Link href="https://policies.google.com/terms">Google Play Services</Link>
          </li>
          <li>
          ...
          <li>
            <Link href="https://mbasic.facebook.com/legal/terms/plain_text_terms/">Facebook</Link>
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          territory (i.e., region or country) without disabling data roaming. If you are not the
        ...
        <p>
          ...
          times, they do rely on third parties to provide information to them so that they can make
          it available to you. The Service Provider accepts no liability for any loss, direct or
        ...
        <p>
          ...
          to you. Unless they inform you otherwise, upon any termination, (a) the rights and
          licenses granted to you in these terms will end; (b) you must cease using the application,
        ...
        <br />
        <p>These terms and conditions are effective as of 2025-02-04</p>
        <br />
        <strong>Contact us</strong>
        <br />
        <p>
          If you have any questions or suggestions about the Terms and Conditions, please do not
          hesitate to contact the Service Provider at info@fusionstarforce.com.
        </p>
      </div>
    </section>
  );
